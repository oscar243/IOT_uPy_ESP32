...
& $python3 aws-iot-device-sdk-python-v2\samples\pubsub.py --endpoint a2wcwx5a1jazso-ats.iot.us-east-1.amazonaws.com --ca_file root-CA.crt --cert ECI.cert.pem --key ECI.private.key --client_id basicPubSub --topic sdk/test/Python --count 0